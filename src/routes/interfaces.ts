...
export type CarDetailsScreenProps = StackNavigationProp<
  RootStackParamList,
  "CarDetails"
>;
...
export type SchedulingDetailsScreenProps = StackNavigationProp<RootStackParamList, "SchedulingDetails">;